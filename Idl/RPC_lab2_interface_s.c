...
extern const MIDL_SERVER_INFO RPC_lab2_interface_ServerInfo;

extern const RPC_DISPATCH_TABLE RPC_lab2_interface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE RPC_lab2_interface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x64fd4134,0x1300,0x11eb,{0xad,0xc1,0x02,0x42,0xac,0x12,0x00,0x02}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&RPC_lab2_interface_v1_0_DispatchTable,
    0,
    0,
    0,
    &RPC_lab2_interface_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE RPC_lab2_interface_v1_0_s_ifspec = (RPC_IF_HANDLE)& RPC_lab2_interface___RpcServerInterface;
...
static const MIDL_STUB_DESC RPC_lab2_interface_StubDesc = 
    {
    (void *)& RPC_lab2_interface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION RPC_lab2_interface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE RPC_lab2_interface_v1_0_DispatchTable = 
    {
    6,
    (RPC_DISPATCH_FUNCTION*)RPC_lab2_interface_table
    };

static const SERVER_ROUTINE RPC_lab2_interface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RPC_login,
    (SERVER_ROUTINE)RPC_logout,
    (SERVER_ROUTINE)RPC_download,
    (SERVER_ROUTINE)RPC_upload,
    (SERVER_ROUTINE)RPC_delete,
    (SERVER_ROUTINE)RPC_exit
    };

static const MIDL_SERVER_INFO RPC_lab2_interface_ServerInfo = 
    {
    &RPC_lab2_interface_StubDesc,
    RPC_lab2_interface_ServerRoutineTable,
    RPC_lab2_interface__MIDL_ProcFormatString.Format,
    RPC_lab2_interface_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
